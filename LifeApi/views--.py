...
def EventApi(request):
    ...
    if price_type:
        p['head']=FindEvent(catid='111',cityid = cityid,page=page,offset=3,ver=cds.get('version',''))
        price_type='1,6'
        catid='102,103,104,105,106,107,108,109,110,112'
        
    p['list']=FindEvent(catid,cityid,people,price_type,money_min,money_max,random,page=page,offset=offset,ver=cds.get('version',''))
