...
class NewEventTable(models.Model):
    ...
    user=models.ForeignKey(Customer,verbose_name=u'注册用户',blank=True,null=True,related_name='event_reg_user')
...
class NewEventPriceUnit(models.Model):
    ...
    type=models.PositiveSmallIntegerField(u'状态',blank=True,null=True,default=0,choices=typ )
...
class NewOrder(models.Model):
    ...
    admin = models.ForeignKey(User,verbose_name=u'创建编辑',blank=True,related_name='order_edit')
...
class NewArticle(models.Model):
    name=models.CharField(u'标题',max_length=100)
    cat= models.ForeignKey(NewEventCat,blank=True,null=True,verbose_name=u'分类',related_name='ar_cat')
